...
#   * Juego en :80 (publicar al router)
...
# Lanzar el panel de admin en segundo plano (puerto 8080)
...
Write-Host ""
Write-Host "URL para jugar:        http://<IP-LAN-o-publica>"
...
# Lanzar el servidor del juego en primer plano (puerto 80)
